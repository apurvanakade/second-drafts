...
categories: [combinatorics, triangles, coloring, Research]
# draft: true
---
...
**Sperner's lemma** is one of the first "non-trivial" theorem I remember hearing about at some summer camp in my high school.
...
2. The vertices that lie on the edges of the triangle are colored with the colors of the vertices at the endpoints of that edge.
3. The vertices that lie on the interior of the triangle are colored with any of the three colors.

The conditions 1, 2 are sometimes called the **Sperner condition**. 

::: {#thm-sperner}

Any triangulation of a triangle satisfying Spener's condition has at least one triangle whose vertices are colored with all three colors.

:::

Without peeking below, can you how many "RGB (rainbow) triangles" are there in the above triangulation?
...
html`<h3>Number of RGB triangles: ${numRGBTriangles}</h3>`
```


---

I know a few proofs of this theorem, of varying levels of sophistication. I think I understand this theorem really well. And yet, I cannot predict the image below. Here I'm coloring each triangle using the following mapping:
