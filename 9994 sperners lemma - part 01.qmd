...
2. The vertices that lie on the edges of the triangle are colored with one of the colors of the endpoints of that edge - *this is critical*. 
...
Any triangulation of a triangle satisfying Sperner's condition has at least one triangle whose vertices are colored with all three colors, i.e., there exists at least one triangle with vertices colored <span style="color:white; background-color:red">red</span>, <span style="color:white; background-color:green">green</span>, and <span style="color:white; background-color:blue">blue</span>.
:::
