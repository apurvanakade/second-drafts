...
The last point is where **Sperner's condition** comes in — it controls which boundary edges are allowed (do you see why?). Putting this all together gives us a key result:
