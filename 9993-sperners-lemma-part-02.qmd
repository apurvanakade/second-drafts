...
Now picture all the possible paths that can be formed by stepping through these `RG` doors — the black lines in the diagram represent all of these paths.
