...
You can see this in the app above: move the blue point around the triangle and watch how the barycentric coordinates change. You can also move the vertices of the red triangle and observe how the coordinates adapt. The red triangle is a grid of barycentric coordinates, and the green point is the corresponding point within that triangle.
