...
Without peeking below, can you count how many rainbow (RGB) triangles there are in the above triangulation?
...
I know a few proofs of this theorem, of varying levels of sophistication. I used to think I understood this theorem really well. And yet, I cannot predict the image below. 

Here, I'm coloring each triangle using the following mapping:
...
When you learn abstract mathematics, it's easy to lose touch with the concrete. What is going on here? What patterns can you see? Why are there so many RGB triangles? **What is the expected number of such triangles?** What about the other colored triangles?
